...
var contactText = document.getElementById("contactName");
firstName.addEventListener("blur", function () {
  if (firstName.value !== '') {
    contactText.textContent = "".concat(firstName.value, "!");
  } else {
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunknnktech"] = self["webpackChunknnktech"] || [];
